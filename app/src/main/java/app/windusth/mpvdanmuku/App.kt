...
import app.windusth.mpvdanmuku.di.DatabaseModule
import app.windusth.mpvdanmuku.di.FileManagerModule
import app.windusth.mpvdanmuku.di.PreferencesModule
import app.windusth.mpvdanmuku.presentation.crash.CrashActivity
import app.windusth.mpvdanmuku.presentation.crash.GlobalExceptionHandler
  ...
  override fun onCreate() {
    ...
    startKoin {
      ...
      modules(
        ...
        DatabaseModule,
        FileManagerModule,
        app.windusth.mpvdanmuku.di.domainModule,
      )
    }
