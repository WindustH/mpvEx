package app.windusth.mpvdanmuku.ui.browser.folderlist
...
import app.windusth.mpvdanmuku.domain.media.model.VideoFolder
...
import app.windusth.mpvdanmuku.preferences.FolderSortType
...
import app.windusth.mpvdanmuku.preferences.SortOrder
...
import app.windusth.mpvdanmuku.ui.browser.dialogs.GridColumnSelector
...
import app.windusth.mpvdanmuku.ui.browser.states.LoadingState
...
object FolderListScreen : Screen {
  ...
  private fun MediaStoreFolderListContent() {
    ...
    val advancedPreferences = koinInject<app.windusth.mpvdanmuku.preferences.AdvancedPreferences>()
  ...
  val folderGridColumns = if (isLandscape) folderGridColumnsLandscape else folderGridColumnsPortrait
    ...
    val selectionManager = rememberSelectionManager(
      ...
      onDeleteItems = { folders, _ ->
        ...
        val videos = app.windusth.mpvdanmuku.repository.MediaFileRepository.getVideosForBuckets(context, ids)
    ...
    LaunchedEffect(permissionState.status) {
      app.windusth.mpvdanmuku.ui.browser.MainScreen.updatePermissionState(
    ...
    Scaffold(
      topBar = {
        if (isSearching) {
          ...
          BrowserTopBar(
            title = stringResource(app.windusth.mpvdanmuku.R.string.app_name),
            ...
            onShareClick = {
              coroutineScope.launch {
                ...
                val allVideos = app.windusth.mpvdanmuku.repository.MediaFileRepository
            ...
            onBlacklistClick = {
              coroutineScope.launch {
                ...
                android.widget.Toast.makeText(
                  context,
                  context.getString(app.windusth.mpvdanmuku.R.string.pref_folders_blacklisted),
            ...
            TooltipBox(
              ...
              ToggleFloatingActionButton(
                modifier = Modifier.animateFloatingActionButton(
                  visible = !selectionManager.isInSelectionMode && isFabVisible.value && !app.windusth.mpvdanmuku.ui.browser.MainScreen.getPermissionDeniedState(),
                ...
                if (isSearchLoading) {
                  ...
                  SearchResultsContent(
                    ...
                    onFolderClick = { folder ->
                      backstack.add(app.windusth.mpvdanmuku.ui.browser.videolist.VideoListScreen(folder.bucketId, folder.name))
                    },
                    onVideoClick = { video ->
...
private fun FolderListContent(
  ...
  foldersWithNewCount: List<app.windusth.mpvdanmuku.ui.browser.folderlist.FolderWithNewCount>,
  ...
  selectionManager: app.windusth.mpvdanmuku.ui.browser.selection.SelectionManager<VideoFolder, String>,
...
private fun SearchResultsContent(
  ...
  navigationBarHeight: androidx.compose.ui.unit.Dp,
  onFolderClick: (app.windusth.mpvdanmuku.domain.media.model.VideoFolder) -> Unit,
  onVideoClick: (app.windusth.mpvdanmuku.domain.media.model.Video) -> Unit,
  mediaLayoutMode: app.windusth.mpvdanmuku.preferences.MediaLayoutMode,
  folderGridColumns: Int,
) {
  val folders = searchResults.filterIsInstance<FileSystemItem.Folder>().map { folder ->
    app.windusth.mpvdanmuku.domain.media.model.VideoFolder(
  ...
  val isGridMode = mediaLayoutMode == app.windusth.mpvdanmuku.preferences.MediaLayoutMode.GRID
...
private suspend fun searchFoldersAndVideos(
  ...
  try {
    ...
    val folders = app.windusth.mpvdanmuku.repository.MediaFileRepository
    ...
    folders.forEach { folder ->
      ...
      val videos = app.windusth.mpvdanmuku.repository.MediaFileRepository
