...
import app.windusth.mpvdanmuku.ui.browser.cards.PlaylistCard
...
import app.windusth.mpvdanmuku.ui.browser.sheets.PlaylistActionSheet
...
object PlaylistScreen : Screen {
  ...
  private fun PlaylistListContent(
    ...
    selectionManager: app.windusth.mpvdanmuku.ui.browser.selection.SelectionManager<PlaylistWithCount, Int>,
