package app.windusth.mpvdanmuku.ui.browser.networkstreaming.proxy

import android.util.Log
import app.windusth.mpvdanmuku.domain.network.NetworkConnection
import app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.NetworkClient
import app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.NetworkClientFactory
    ...
    return runBlocking {
      try {
        when (streamInfo.client) {
          is app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.SmbClient -> {
            getFileSizeSMB(streamInfo)
          }

          is app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.FtpClient -> {
            getFileSizeFTP(streamInfo)
          }

          is app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.WebDavClient -> {
            val webDavClient =
              streamInfo.client as app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.WebDavClient
            ...
            val ftpClient =
              streamInfo.client as? app.windusth.mpvdanmuku.ui.browser.networkstreaming.clients.FtpClient
