package app.windusth.mpvdanmuku.ui.player.controls
...
import app.windusth.mpvdanmuku.ui.player.Decoder
import app.windusth.mpvdanmuku.ui.player.Panels
import app.windusth.mpvdanmuku.ui.player.Sheets
import app.windusth.mpvdanmuku.ui.player.TrackNode
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.AspectRatioSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.AudioTracksSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.ChaptersSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.DecodersSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.DanmakuSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.FrameNavigationSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.MoreSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.PlaybackSpeedSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.PlaylistSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.SubtitlesSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.OnlineSubtitleSearchSheet
import app.windusth.mpvdanmuku.ui.player.controls.components.sheets.VideoZoomSheet
...
fun PlayerSheets(
  sheetShown: Sheets,
  viewModel: app.windusth.mpvdanmuku.ui.player.PlayerViewModel,
  // subtitles sheet
  ...
  when (sheetShown) {
    ...
    Sheets.SubtitleTracks -> {
      ...
      val subtitlesPreferences = koinInject<app.windusth.mpvdanmuku.preferences.SubtitlesPreferences>()
      ...
      if (showFilePicker) {
          app.windusth.mpvdanmuku.ui.browser.dialogs.FilePickerDialog(
              isOpen = true,
    ...
    Sheets.AspectRatios -> {
      ...
      val customRatios =
        customRatiosSet.mapNotNull { str ->
          val parts = str.split("|")
          if (parts.size == 2) {
            app.windusth.mpvdanmuku.ui.player.controls.components.sheets.AspectRatio(
              label = parts[0],
      ...
      AspectRatioSheet(
        ...
        onSelectRatio = { ratio ->
          if (ratio < 0) {
            ...
            viewModel.changeVideoAspect(app.windusth.mpvdanmuku.ui.player.VideoAspect.Fit)
          } else {
