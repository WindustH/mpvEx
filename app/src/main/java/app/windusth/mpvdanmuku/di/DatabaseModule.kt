...
import app.windusth.mpvdanmuku.database.repository.PlaybackStateRepositoryImpl
import app.windusth.mpvdanmuku.database.repository.PlaylistRepository
import app.windusth.mpvdanmuku.database.repository.RecentlyPlayedRepositoryImpl
import app.windusth.mpvdanmuku.domain.playbackstate.repository.PlaybackStateRepository
import app.windusth.mpvdanmuku.domain.recentlyplayed.repository.RecentlyPlayedRepository
...
val DatabaseModule =
  module {
    ...
    single<RecentlyPlayedRepository> {
      RecentlyPlayedRepositoryImpl(get<MpvDanmukuDatabase>().recentlyPlayedDao())
    }

    single { ThumbnailRepository(androidContext()) }

    single {
      app.windusth.mpvdanmuku.database.repository.VideoMetadataCacheRepository(
        context = androidContext(),
        dao = get<MpvDanmukuDatabase>().videoMetadataDao(),
      )
    }
    ...
    single {
      app.windusth.mpvdanmuku.repository.NetworkRepository(
        dao = get(),
      )
    }
    ...
    single {
      PlaylistRepository(
        playlistDao = get<MpvDanmukuDatabase>().playlistDao(),
      )
    }
  }
