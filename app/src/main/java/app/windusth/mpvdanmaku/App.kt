...
import app.windusth.mpvdanmaku.di.DatabaseModule
import app.windusth.mpvdanmaku.di.FileManagerModule
import app.windusth.mpvdanmaku.di.PreferencesModule
import app.windusth.mpvdanmaku.presentation.crash.CrashActivity
import app.windusth.mpvdanmaku.presentation.crash.GlobalExceptionHandler
  ...
  override fun onCreate() {
    ...
    startKoin {
      ...
      modules(
        ...
        DatabaseModule,
        FileManagerModule,
        app.windusth.mpvdanmaku.di.domainModule,
      )
    }
