...
import app.windusth.mpvdanmaku.ui.player.Decoder
import app.windusth.mpvdanmaku.ui.player.Panels
import app.windusth.mpvdanmaku.ui.player.Sheets
import app.windusth.mpvdanmaku.ui.player.TrackNode
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.AspectRatioSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.AudioTracksSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.ChaptersSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.DecodersSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.DanmakuSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.FrameNavigationSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.MoreSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.PlaybackSpeedSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.PlaylistSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.SubtitlesSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.OnlineSubtitleSearchSheet
import app.windusth.mpvdanmaku.ui.player.controls.components.sheets.VideoZoomSheet
...
fun PlayerSheets(
  sheetShown: Sheets,
  viewModel: app.windusth.mpvdanmaku.ui.player.PlayerViewModel,
  // subtitles sheet
  ...
  when (sheetShown) {
    ...
    Sheets.SubtitleTracks -> {
      ...
      val subtitlesPreferences = koinInject<app.windusth.mpvdanmaku.preferences.SubtitlesPreferences>()
      ...
      if (showFilePicker) {
          app.windusth.mpvdanmaku.ui.browser.dialogs.FilePickerDialog(
              isOpen = true,
    ...
    Sheets.AspectRatios -> {
      ...
      val customRatios =
        customRatiosSet.mapNotNull { str ->
          val parts = str.split("|")
          if (parts.size == 2) {
            app.windusth.mpvdanmaku.ui.player.controls.components.sheets.AspectRatio(
              label = parts[0],
      ...
      AspectRatioSheet(
        ...
        onSelectRatio = { ratio ->
          if (ratio < 0) {
            ...
            viewModel.changeVideoAspect(app.windusth.mpvdanmaku.ui.player.VideoAspect.Fit)
          } else {
