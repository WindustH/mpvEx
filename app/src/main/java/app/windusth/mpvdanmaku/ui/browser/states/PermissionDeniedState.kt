...
package app.windusth.mpvdanmaku.ui.browser.states
...
fun PermissionDeniedState(
  ...
  if (showExplanationDialog) {
    ...
    val githubUrl = "https://github.com/WindustH/mpvDanmaku"
      ...
      text = {
        Column(
          ...
          if (isPlayStoreBuild) {
            ...
            Text(
              text = "mpvDanmaku has always required storage access permission as it's essential for the app to find all media and subtitle files on your device, including the ones that are not supported by the system.",
              style = MaterialTheme.typography.bodyMedium,
              color = MaterialTheme.colorScheme.onSurfaceVariant,
            )
          ...
          Text(
            text = "mpvDanmaku is an open source project. You can review the source code and verify how permissions are used by visiting our GitHub repository at:",
            style = MaterialTheme.typography.bodyMedium,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
          )
