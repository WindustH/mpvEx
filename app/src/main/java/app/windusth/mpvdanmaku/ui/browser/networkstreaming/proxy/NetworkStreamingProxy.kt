package app.windusth.mpvdanmaku.ui.browser.networkstreaming.proxy

import android.util.Log
import app.windusth.mpvdanmaku.domain.network.NetworkConnection
import app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.NetworkClient
import app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.NetworkClientFactory
    ...
    return runBlocking {
      try {
        when (streamInfo.client) {
          is app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.SmbClient -> {
            getFileSizeSMB(streamInfo)
          }

          is app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.FtpClient -> {
            getFileSizeFTP(streamInfo)
          }

          is app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.WebDavClient -> {
            val webDavClient =
              streamInfo.client as app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.WebDavClient
            ...
            val ftpClient =
              streamInfo.client as? app.windusth.mpvdanmaku.ui.browser.networkstreaming.clients.FtpClient
