package app.windusth.mpvdanmaku.ui.browser.folderlist
...
import app.windusth.mpvdanmaku.domain.media.model.VideoFolder
...
import app.windusth.mpvdanmaku.preferences.FolderSortType
import app.windusth.mpvdanmaku.preferences.FolderViewMode
...
import app.windusth.mpvdanmaku.preferences.SortOrder
...
import app.windusth.mpvdanmaku.ui.browser.dialogs.GridColumnSelector
...
import app.windusth.mpvdanmaku.ui.browser.filesystem.FileSystemBrowserRootScreen
...
import app.windusth.mpvdanmaku.ui.browser.states.LoadingState
...
object FolderListScreen : Screen {
  ...
  private fun MediaStoreFolderListContent() {
    ...
    val advancedPreferences = koinInject<app.windusth.mpvdanmaku.preferences.AdvancedPreferences>()
  ...
  val folderGridColumns = if (isLandscape) folderGridColumnsLandscape else folderGridColumnsPortrait
    ...
    val selectionManager = rememberSelectionManager(
      ...
      onDeleteItems = { folders, _ ->
        ...
        val videos = app.windusth.mpvdanmaku.repository.MediaFileRepository.getVideosForBuckets(context, ids)
    ...
    LaunchedEffect(permissionState.status) {
      app.windusth.mpvdanmaku.ui.browser.MainScreen.updatePermissionState(
    ...
    Scaffold(
      topBar = {
        if (isSearching) {
          ...
          BrowserTopBar(
            title = stringResource(app.windusth.mpvdanmaku.R.string.app_name),
            ...
            onShareClick = {
              coroutineScope.launch {
                ...
                val allVideos = app.windusth.mpvdanmaku.repository.MediaFileRepository
            ...
            onBlacklistClick = {
              coroutineScope.launch {
                ...
                android.widget.Toast.makeText(
                  context,
                  context.getString(app.windusth.mpvdanmaku.R.string.pref_folders_blacklisted),
            ...
            TooltipBox(
              ...
              ToggleFloatingActionButton(
                modifier = Modifier.animateFloatingActionButton(
                  visible = !selectionManager.isInSelectionMode && isFabVisible.value && !app.windusth.mpvdanmaku.ui.browser.MainScreen.getPermissionDeniedState(),
                ...
                if (isSearchLoading) {
                  ...
                  SearchResultsContent(
                    ...
                    onFolderClick = { folder ->
                      backstack.add(app.windusth.mpvdanmaku.ui.browser.videolist.VideoListScreen(folder.bucketId, folder.name))
                    },
                    onVideoClick = { video ->
...
private fun FolderListContent(
  ...
  foldersWithNewCount: List<app.windusth.mpvdanmaku.ui.browser.folderlist.FolderWithNewCount>,
  ...
  selectionManager: app.windusth.mpvdanmaku.ui.browser.selection.SelectionManager<VideoFolder, String>,
...
private fun SearchResultsContent(
  ...
  navigationBarHeight: androidx.compose.ui.unit.Dp,
  onFolderClick: (app.windusth.mpvdanmaku.domain.media.model.VideoFolder) -> Unit,
  onVideoClick: (app.windusth.mpvdanmaku.domain.media.model.Video) -> Unit,
  mediaLayoutMode: app.windusth.mpvdanmaku.preferences.MediaLayoutMode,
  folderGridColumns: Int,
) {
  val folders = searchResults.filterIsInstance<FileSystemItem.Folder>().map { folder ->
    app.windusth.mpvdanmaku.domain.media.model.VideoFolder(
  ...
  val isGridMode = mediaLayoutMode == app.windusth.mpvdanmaku.preferences.MediaLayoutMode.GRID
...
private suspend fun searchFoldersAndVideos(
  ...
  try {
    ...
    val folders = app.windusth.mpvdanmaku.repository.MediaFileRepository
    ...
    folders.forEach { folder ->
      ...
      val videos = app.windusth.mpvdanmaku.repository.MediaFileRepository
