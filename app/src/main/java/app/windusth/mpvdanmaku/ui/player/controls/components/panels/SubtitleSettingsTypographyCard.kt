package app.windusth.mpvdanmaku.ui.player.controls.components.panels
...
import app.windusth.mpvdanmaku.preferences.SubtitleJustification
...
import app.windusth.mpvdanmaku.presentation.components.ExpandableCard
import app.windusth.mpvdanmaku.presentation.components.ExposedTextDropDownMenu
import app.windusth.mpvdanmaku.presentation.components.SliderItem
import app.windusth.mpvdanmaku.ui.player.controls.CARDS_MAX_WIDTH
import app.windusth.mpvdanmaku.ui.player.controls.panelCardsColors
    ...
    withContext(Dispatchers.IO) {
      ...
      if (fileManager.exists(fontsDir)) {
        fonts.addAll(
          fileManager
            .listFiles(fontsDir)
            .filter { fileManager.isFile(it) && fileManager.getName(it).lowercase().matches(app.windusth.mpvdanmaku.utils.media.FONT_FILE_REGEX) }
            .mapNotNull {
              runCatching {
